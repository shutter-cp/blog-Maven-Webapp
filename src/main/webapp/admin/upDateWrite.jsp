				...
				<div class="container-fluid am-cf">
					<div class="row">
						<div class="am-u-sm-12 am-u-md-12 am-u-lg-9">
							<div class="page-header-heading"><span class="am-icon-home page-header-heading-icon"></span> 创造中心 <small>修改</small></div>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
							<div class="widget am-cf">
								<form action="${basePath }/admin/write/upDateDo" method="post">
									<div class="widget-head am-cf">
										<div class="am-g">
											<div class="am-u-sm-6">
												<label>标题</label>
												<input type="text" class="am-form-field am-round" name="title" id="" value="${page.title }" />
											</div>
											<div class="am-u-sm-3">
												<label>作者</label>
												<input type="text" class="am-form-field am-round" name="author" value="${page.author }" />
											</div>
											<div class="am-u-sm-3">
												<label>日期</label>
										...
										<div class="am-g">
											<div class="am-u-sm-5">
												...
												<select name="sortId" id="sortId"  data-am-selected="{btnWidth: '100%', btnSize: 'sm', btnStyle: 'secondary'}" >
													<option value="${page.sortId }">${page.sortName }</option>
											...
											<div class="am-u-sm-5">
												...
												<select name="labelId" id="labelId" data-am-selected="{btnWidth: '100%', btnSize: 'sm', btnStyle: 'warning'}" >
													<option value="${page.labelId }">${page.name }</option>
												</select>
											</div>
											<div class="am-u-sm-2">
												<label>添加标签</label>
									...
									<div class="widget-body am-fr">
										<textarea name="texts" id="editor" >${page.mainText }</textarea>
									</div>
